...
public class R1000cnpj32243347000151 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            nrInscElement.appendChild(doc.createTextNode("32243347000151"));
            ...
            eventoElement.setAttribute("Id", "ID" + tipoInscricao + "32243347000151" +anomesdiahora+"00001");
            ...
            evtInfoContriElement.setAttribute("id", "ID" + tipoInscricao + "32243347000151" +anomesdiahora+"00001");
            ...
            nrInsc1Element.appendChild(doc.createTextNode("32243347000151"));
